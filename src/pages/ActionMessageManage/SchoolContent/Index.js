...
@connect(({ schoolContent, loading }) => ({
  schoolContent,
  loading: loading.effects['schoolContent/fetchList'],
}))
export default class Index extends PureComponent {
  componentDidMount() {
    const { dispatch } = this.props;
    dispatch({
      type: 'schoolContent/fetchList',
      payload: {},
    });
  }
  ...
  render() {
    const {
      schoolContent: { page, pageSize, total, list, loading, modalVisible },
    } = this.props;
