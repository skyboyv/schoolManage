...
@connect(({ studentContent, loading }) => ({
  studentContent,
  loading: loading.effects['studentContent/fetchList'],
}))
export default class Index extends PureComponent {
  componentDidMount() {
    const { dispatch } = this.props;
    dispatch({
      type: 'studentContent/fetchList',
      payload: {},
    });
  }
  ...
  render() {
    const {
      studentContent: { page, pageSize, total, list, loading, modalVisible },
    } = this.props;
