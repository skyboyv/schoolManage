export default {
  ...
  'form.title.label': '商品名称',
  'form.title.placeholder': '请输入商品名称',
  'form.price.label': '商品价格',
  'form.price.placeholder.start': '请输入商品价格',
  'form.date.placeholder.end': '结束日期',
  'form.goal.label': '商品描述',
  'form.goal.placeholder': '请输入商品描述',
